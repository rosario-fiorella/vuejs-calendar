<template>
  <v-row>
    ...
    <v-col sm="4" xs="12">
      <v-card outlined tile>
        <v-card-text>
          <v-autocomplete
            ...
            :prepend-inner-icon="fields.search.icon"
          ...
          <v-select
            ...
            :prepend-inner-icon="fields.sortBy.icon.alpha"
      ...
      <v-list class="mt-4 five-line" outlined dense>
        <v-list-item-group>
          <v-list-item link v-for="(item, i) in notify.list" :key="i">
            <v-list-item-content>
              <v-list-item-title>{{ item.title }}</v-list-item-title>
              <v-list-item-subtitle>
                  <v-icon small>{{ item.date.icon }}</v-icon> {{ item.date.start }}
                </v-list-item-subtitle>
              <v-list-item-subtitle>
                  <v-icon small>{{ item.date.icon }}</v-icon> {{ item.date.end }}
                </v-list-item-subtitle>
